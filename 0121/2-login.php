    ...
    <script type="text/javascript">
        $(function() {
            $('input[name="btn"]').click(function() {
                ...
                console.log($('[name="password"]').val().trim());
                let data = {}
                data.username = $.trim($('[name="username"]').val());
                data.password = $.trim($('[name="password"]').val());
                // $.post('3-dosubmit.php', data, function(res) {
                //     console.log(res);
                // })
                // $.post('3-doSubmit-1.php', data, function(res) {
                //     console.log(res);
                // })
                $.post('3-doSubmit-2.php', data, function(res) {
                    console.log(res);
                })
            })
        })
